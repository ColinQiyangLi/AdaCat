...
hparams = HParams(
    ...
    scalar_embeddings=("scalar",),
    # 1) Logistic or 2) Normal or 3) AdaCat
    output_distribution="Logistic",
    log_scale_min=-16.0,
    adacat_smooth_coeff=0.01,
    adacat_smooth_type="uniform",
    adacat_smooth_dequant="analytic",
    adacat_fixed_x=False,
    adacat_fixed_y=False,
    entropy_lam=0.,
